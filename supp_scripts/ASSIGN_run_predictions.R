...
#----------------------------------------------------#
working_dir         <- "/restricted/projectnb/combat/work/yuqingz/refcombat_review_201803/compare_sva_ruv/ICBP"
basedir             <- "RUV"
input_rda           <- "/restricted/projectnb/combat/work/yuqingz/refcombat_review_201803/compare_sva_ruv/ICBP/RUV/icbp_RUV.rda"
